...
class Config:
    ...
    OUTPUT_DIR = f"{BASE_DIR}/checkpoints/llamax3-8b-lora-fewshot-{datetime.now().strftime('%Y%m%d_%H%M%S')}"
    FINAL_MODEL_DIR = f"{BASE_DIR}/models/llamax3-8b-fewshot-final"
    ...
    WANDB_RUN_NAME = f"llamax3-8b-lora-fewshot-r{LORA_R}-lr{LEARNING_RATE}"
...
def format_prompt_for_training(syllogism, validity):
    """
    Formato de prompt para training CON FEW-SHOT
    Incluye 2 ejemplos antes del target syllogism
    """
...
def main():
    ...
    wandb.init(
        ...
        config={
            ...
            "prompt_type": "few-shot"  # Añadido
        }
    )
    
    print("=" * 50)
    print("SEMEVAL 2026 TASK 11 - LORA FINE-TUNING (FEW-SHOT)")
    print("=" * 50)
    ...
    print(f"\ntokenize dataset (few-shot format)")
    ...
    # [8] ENTRENAR
    print("\n" + "=" * 50)
    print("training (FEW-SHOT FORMAT)")
    print("=" * 50 + "\n")
    ...
    print("\n" + "=" * 50)
    print("training completed (FEW-SHOT)")
    print("=" * 50)
